...
special: src/special.o src/io.o src/offset.o
	$(CC) $(CFLAGS) $(LIBS) -o special \
	src/special.o \
	src/io.o \
	src/offset.o

inventory: src/inventory.o src/io.o src/offset.o
	$(CC) $(CFLAGS) $(LIBS) -o inventory \
	src/inventory.o \
	src/io.o \
	src/offset.o

clean:
	rm -f src/*.o inventory special critical dat2dump save_info perks traits
